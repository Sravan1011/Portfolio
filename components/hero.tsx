      ...
      <div className="flex flex-col lg:flex-row items-start gap-12 relative z-10">
        ...
        <div className="flex-1 space-y-6">
          ...
          <div className="space-y-4 text-gray-600 leading-relaxed">
            ...
            <p>
              i have worked for{" "}
              <span className="text-gray-900 font-medium">startups</span>, spent a lot of time as
            ...
            <p>
              ...
              <span className="text-gray-900 font-medium"> honeywell </span> and built websites that someone
              found useful.
            </p>
            <p>
